...
<link href="https://fonts.googleapis.com/css2?family=Hedvig+Letters+Serif:opsz@12..24&display=swap" rel="stylesheet"> <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" integrity="sha512-wmQ6AQ62fTOxy2vC/UN+TTS7d2oSUuU2OpOSDQVuBvUEkTf3zD5tnsNmOOXSJ7vjIJFmiGfBtSF7vOcNZN0xEQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
</head>
<body>
        ...
        <div class="col-md-8">
            ...
            <div class="modal fade" id="addPartyModal" tabindex="-1" role="dialog" aria-labelledby="addPartyModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addPartyModalLabel">Voeg nieuwe partij toe</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                            ...
                            <form id="addPartyForm">
                                <div class="form-group">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="addImage">Kies foto</label>
                                    </div>
                                </div>
                                <div class="form-group">
...
<script>
  ...
  $(document).ready(function() {
    $('.deleteStellingBtn').click(function() {
        var stellingId = $(this).data('id'); // Corrected variable name

        if (confirm("Ben je zeker dat je deze Stelling wil verwijderen?")) {
            $.ajax({
                url: 'delete-stelling.php',
                type: 'POST',
                data: { id: stellingId }, // Corrected variable name
                success: function(response) {
                    console.log(response);
                    location.reload(); 
                },
