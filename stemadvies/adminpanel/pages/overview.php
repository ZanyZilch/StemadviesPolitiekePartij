                            ...
                            <form id="stellingForm">
                                ...
                                <input type="hidden" id="editStellingId" name="editStellingId">
                                 <div class="form-group">
                                    ...
                                    <div class="d-flex">
                                        <div class="mr-2">
                                            <label for="editXCoordinateStelling">X-coordinate:</label>
                                            <select class="form-control selectpicker" id="editXCoordinateStelling" name="editXCoordinateStelling" data-live-search="true" size="4">
                                                <?php
                                                for ($i = -5; $i <= 5; $i++) {
                                        ...
                                        <div>
                                            <label for="editYCoordinateStelling">Y-coordinate:</label>
                                            <select class="form-control selectpicker" id="editYCoordinateStelling" name="editYCoordinateStelling" data-live-search="true" size="4">
                                                <?php
                                                for ($i = -5; $i <= 5; $i++) {
                                                    echo "<option value='" . $i . "'>" . $i . "</option>";
                                                }
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="editMeningForm">
                                <div class="form-group">
                                    <label for="editPartijMeningID">Partij:</label>
                                    <select class="form-control selectpicker" id="editPartijMeningID" name="editPartijMeningID" data-live-search="true">
                                    <?php
                                        $partySql = "SELECT * FROM `stemadvies_politiekepartij`";
                                        $partyStmt = $verbinding->prepare($partySql);
                                        $partyStmt->execute();
                                        $partyResult = $partyStmt->fetchAll();

                                        foreach ($partyResult as $row) {
                                            echo "<option value='" . $row['PartijID'] . "'>" . $row['PartijNaam'] . "</option>";
                                        }
                                    ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                        $stellingSql = "SELECT * FROM `stemadvies_stelling`";
                                        ...
                                        foreach ($stellingResult as $row) {
                                            echo"<option value='". $row['StellingID'] . "'>". $row['StellingInhoud'] . "</option>";
                                        }
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="editMening" name="editMening">
                                        <option value="Eens">Eens</option>
                                        <option value="Oneens">Oneens</option>
                                        <option value="Neutraal">Weet niet</option>
                                    </select>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <form id="addStellingForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex">
                                        <div class="mr-2">
                                            <label for="addXCoordinateStelling">X-coordinate:</label>
                                            <select class="form-control selectpicker" id="addXCoordinateStelling" name="addXCoordinateStelling" data-live-search="true" size="4">
                                                <?php
                                                for ($i = -5; $i <= 5; $i++) {
                                                    echo "<option value='" . $i . "'>" . $i . "</option>";
                                                }
                                        ...
                                        <div>
                                            <label for="addYCoordinateStelling">Y-coordinate:</label>
                                            <select class="form-control selectpicker" id="addYCoordinateStelling" name="addYCoordinateStelling" data-live-search="true" size="4">
                                                <?php
                                                for ($i = -5; $i <= 5; $i++) {
                                                    echo "<option value='" . $i . "'>" . $i . "</option>";
                                                }
                        ...
                        <div class="modal-body">
                            ...
                            <form id="addMeningForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="addMening" name="addMening">
                                        <option value="Eens">Eens</option>
                                        <option value="Oneens">Oneens</option>
                                        <option value="Neutraal">Weet niet</option>
                                    </select>
